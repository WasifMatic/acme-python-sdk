...
| `card_type` | [`CardBrand`](../../doc/models/card-brand.md) | Optional, Read-only | The card brand or network. Typically used in the response.<br><br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `255`, *Pattern*: `^[A-Z_]+$` |
