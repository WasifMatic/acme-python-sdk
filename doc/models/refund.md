...
| `id` | `str` | Optional, Read-only | The PayPal-generated ID for the refund. |
...
| `note_to_payer` | `str` | Optional, Read-only | The reason for the refund. Appears in both the payer's transaction history and the emails that the payer receives. |
| `seller_payable_breakdown` | [`SellerPayableBreakdown`](../../doc/models/seller-payable-breakdown.md) | Optional, Read-only | The breakdown of the refund. |
