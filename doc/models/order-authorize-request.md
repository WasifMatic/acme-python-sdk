...
|  --- | --- | --- | --- |
| `payment_source` | [`OrderAuthorizeRequestPaymentSource`](../../doc/models/order-authorize-request-payment-source.md) | Optional | The payment source definition. |
...
order_authorize_request = OrderAuthorizeRequest(
    payment_source=OrderAuthorizeRequestPaymentSource(
        card=CardRequest(
            name='name6',
            number='number6',
            expiry='expiry4',
