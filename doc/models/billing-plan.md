...
|  --- | --- | --- | --- |
| `id` | `str` | Optional, Read-only | The unique PayPal-generated ID for the plan.<br><br>**Constraints**: *Minimum Length*: `26`, *Maximum Length*: `26`, *Pattern*: `^P-[A-Z0-9]*$` |
...
billing_plan = BillingPlan(
    ...
    name='name8',
    status=SubscriptionPlanStatus.CREATED,
